...
import { loadCampaigns, campaignProgress, type OutreachCampaign } from '@/lib/campaigns';
          ...
          {campaigns.map(c => {
            ...
            return (
              <Link
                ...
                className="bg-zinc-900 rounded-xl border border-zinc-800 p-4 md:p-5 space-y-3 hover:border-zinc-700 transition block"
              >
